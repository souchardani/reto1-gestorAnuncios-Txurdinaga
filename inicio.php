...
<body onload="init()">
  <header>
    ...
    <div>
        ...
        <div id="dropdown-content">
            <a href="./php/Editar-usuarios.php">Mi Perfil</a>
            <a href="./php/Perfil-administrador.php">Panel Control (Admin)</a>
  ...
  <nav id="nav-links">
      <ul>
        ...
        <a class="li-anuncios" href="./php/Anuncios.php">
          <li>Anuncios</li>
        </a>
        <a class="li-crear" href="./php/Crear-anuncio.php">
          <li>Crear anuncio</li>
        </a>
